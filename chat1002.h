...
/* Structure function to initialise linked list */
...
typedef struct node_properties node_properties;
typedef struct node_properties *node_ptr;

node_ptr head_who, head_where, head_what; // to point to head of 3 intent linked lists (what, where, who)
node_ptr temp_who, temp_where, temp_what; // for ptr traversal 
